...
describe('DbAccount Usecase', () => {
  // teste para chamar o encripter e garantir a cyptografia...
  ...
  // teste de um metodo que vai criar uma conta
  ...
  // se retornar uma exceção o teste vai repassar para o método uq esta
  ...
  // se tudo der certo vai ser retornado a resposta correta
