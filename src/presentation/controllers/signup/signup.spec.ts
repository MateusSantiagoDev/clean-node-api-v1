...
import type { EmailValidator, AccountModel, AddAccountModel, AddAccount } from './signup-protocols'
...
describe('SignUp Controller', () => {
  ...
  // testa se o password e passwordConfirmation não são iguais
  ...
  test('Should return 500 if EmailValidator throws', () => {
    const { sut, emailValidatorStub } = makeSut()
    jest.spyOn(emailValidatorStub, 'invalid').mockImplementationOnce(() => {
      throw new Error()
    })
    const httpRequest = {
      body: {
